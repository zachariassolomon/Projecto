...
<html>
<jsp:useBean id="TarefaBean" scope="page" class="siaadao.TarefaProcessor" />
...
<form method="POST" name="form1" action=Tarefa.jsp>
	<table>
		...
		<tr>
			<td>Titulo : </td>
			<td><input type=text name="titulo" value="<jsp:getProperty name="TarefaBean" property="titulo"/>" /></td>
		</tr>
		<tr>
			<td>Last_updated : </td>
			<td><input type=text name="last_updated" value="<jsp:getProperty name="TarefaBean" property="last_updated"/>" /></td>
		</tr>
		<tr>
