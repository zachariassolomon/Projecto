...
public class InteracaoDAO {
	...
	public static Interacao loadInteracaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Interacao) session.load(siaadao.Interacao.class, new Integer(ID));
		}
		catch (Exception e) {
	...
	public static Interacao getInteracaoByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Interacao) session.get(siaadao.Interacao.class, new Integer(ID));
		}
		catch (Exception e) {
	...
	public static Interacao loadInteracaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Interacao) session.load(siaadao.Interacao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
	...
	public static Interacao getInteracaoByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Interacao) session.get(siaadao.Interacao.class, new Integer(ID), lockMode);
		}
		catch (Exception e) {
	...
	public static List queryInteracao(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From siaadao.Interacao as Interacao");
		if (condition != null)
	...
	public static Interacao createInteracao() {
		return new siaadao.Interacao();
	}
	
	public static boolean save(siaadao.Interacao interacao) throws PersistentException {
		try {
			siaadao.ProjectoPersistentManager.instance().saveObject(interacao);
			return true;
		}
		catch (Exception e) {
			_logger.error("save(siaadao.Interacao interacao)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean delete(siaadao.Interacao interacao) throws PersistentException {
		try {
			siaadao.ProjectoPersistentManager.instance().deleteObject(interacao);
			return true;
		}
		catch (Exception e) {
			_logger.error("delete(siaadao.Interacao interacao)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean deleteAndDissociate(siaadao.Interacao interacao)throws PersistentException {
		try {
			if (interacao.getUser() != null) {
				interacao.getUser().interacoes.remove(interacao);
			}
	...
	public static boolean deleteAndDissociate(siaadao.Interacao interacao, org.orm.PersistentSession session)throws PersistentException {
		try {
			if (interacao.getUser() != null) {
				interacao.getUser().interacoes.remove(interacao);
			}
	...
	public static boolean refresh(siaadao.Interacao interacao) throws PersistentException {
		try {
			siaadao.ProjectoPersistentManager.instance().getSession().refresh(interacao);
			return true;
		}
		catch (Exception e) {
			_logger.error("refresh(siaadao.Interacao interacao)", e);
			throw new PersistentException(e);
		}
	}
	
	public static boolean evict(siaadao.Interacao interacao) throws PersistentException {
		try {
			siaadao.ProjectoPersistentManager.instance().getSession().evict(interacao);
			return true;
		}
		catch (Exception e) {
			_logger.error("evict(siaadao.Interacao interacao)", e);
			throw new PersistentException(e);
		}
	}
