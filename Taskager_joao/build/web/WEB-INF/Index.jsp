                    ...
                    <div class="form-group">
                        <%
                            ...
                            if (username!=null && request.getAttribute("user_ok").equals("no"))
                                out.println("<span style=\"color:red\">Utilizador <b>"+username+"</b> não existe!&nbsp</span>&nbsp;"
                ...
                <div class="panel panel-default">
                    ...
                    <section class="panel-body">
                        ...
                        <!--
                            REGISTER FORM 
                        -->
                        <form id="register_form"  action="Index" method="post" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-sm-12">   
                                    <%
                                        
                                    %>
                                    <label for="register_username">Nome de utilizador:</label>
                                    <input type="text" id="register_username"  class="form-control" value="" name="register_username" required="required" placeholder="Nome de utilizador" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">                                    
                                    <label for="register_password">Palavra-passe:</label>
                                    <input type="password" id="register_password" class="form-control" value="" name="register_password" required="required" placeholder="Palavra-passe" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">                                    
                                    <label for="register_email">Endereço de email:</label>
                                    <input type="email" id="register_email" class="form-control" value="" name="register_email" required="required" placeholder="Email" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
