...
<html>
<jsp:useBean id="InteracaoBean" scope="page" class="siaadao.InteracaoProcessor" />
...
<form method="POST" name="form1" action=Interacao.jsp>
	<table>
		...
		<tr>
			<td>User_userID : </td>
			<td><input type=text name="user_userID" value="<jsp:getProperty name="InteracaoBean" property="user_userID"/>" /></td>
		</tr>
	</table>
