...
<%
siaadao.Tarefa[] tarefas = siaadao.TarefaDAO.listTarefaByQuery(null, null);
for(int i = 0; i < tarefas.length; i++) {
		...
		out.println("</td>");
		out.print("<td>");
		out.print(tarefas[i].getTitulo());
		out.println("</td>");
		out.print("<td>");
		out.print(tarefas[i].getLast_updated());
		out.println("</td>");
		
		siaadao.Projeto projeto = tarefas[i].getProjeto();
		if(projeto != null) {
			out.print("<td>");
...
out.println("<td></td>");
		...
		siaadao.Tarefa tarefa_mae = tarefas[i].getTarefa_mae();
		if(tarefa_mae != null) {
			out.print("<td>");
